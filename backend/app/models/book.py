...
from sqlalchemy import Boolean, DateTime, Enum as SAEnum, ForeignKey, Integer, String, Text, func, Float
...
if TYPE_CHECKING:
    ...
    # from app.models.review_link import ReviewLink  # TEMPORARILY DISABLED - circular dependency
